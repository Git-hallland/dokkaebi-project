import { getCmsBoard, type CmsBoardType } from "@/lib/cms-boards";
...
export const boardCategories: readonly BoardCategory[] = [
  ...
  {
    key: "skills",
    title: getCmsBoard("skills").label,
    href: getCmsBoard("skills").href,
    description: "공식적으로 확인된 도술 정보를 정리하는 게시판입니다.",
    homeDescription: "공식적으로 공개된 도술 정보를 확인한 뒤 제공합니다.",
  },
  {
    key: "items",
    title: getCmsBoard("items").label,
    href: getCmsBoard("items").href,
    description: "출처가 확인된 아이템과 장비 정보를 정리하는 게시판입니다.",
    homeDescription: "획득과 활용 정보를 검증할 수 있는 자료가 확보되면 공개합니다.",
  },
  {
    key: "monsters",
    title: getCmsBoard("monsters").label,
    href: getCmsBoard("monsters").href,
    description: "확인 가능한 몬스터와 보스 정보를 정리하는 게시판입니다.",
    homeDescription: "등장 조건과 공략 정보는 실제 확인 가능한 범위에서 다룹니다.",
  },
  {
    key: "regions",
    title: getCmsBoard("regions").label,
    href: getCmsBoard("regions").href,
    description: "공식적으로 확인된 지역과 NPC 정보를 정리하는 게시판입니다.",
    homeDescription: "지역과 인물 정보가 공식적으로 확인되면 찾아보기 쉽게 연결합니다.",
  },
  {
    key: "dungeons",
    title: getCmsBoard("dungeons").label,
    href: getCmsBoard("dungeons").href,
    description: "참여 조건과 진행 방식이 확인된 콘텐츠를 정리하는 게시판입니다.",
    homeDescription: "참여 조건과 진행 방식이 공개된 콘텐츠부터 정리합니다.",
  },
  {
    key: "crafting",
    title: getCmsBoard("crafting").label,
    href: getCmsBoard("crafting").href,
    description: "검증된 제작과 생활 정보를 정리하는 게시판입니다.",
    homeDescription: "반복해서 찾아볼 가치가 있는 제작·생활 정보를 준비합니다.",
  },
  {
    key: "events",
    title: getCmsBoard("events").label,
    href: getCmsBoard("events").href,
    description: "기간과 출처가 확인된 이벤트와 쿠폰 정보를 정리하는 게시판입니다.",
    homeDescription: "기간과 출처를 다시 확인한 유효한 정보만 제공할 예정입니다.",
  },
  {
    key: "patches",
    title: getCmsBoard("patches").label,
    href: getCmsBoard("patches").href,
...
export function getCmsBoardCategory(key: CmsBoardType) {
  return getBoardCategory(key);
}
